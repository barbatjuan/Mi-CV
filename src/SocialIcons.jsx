    ...
    <StyledWrapper>
      <div className="SocialIcon">
        ...
        <a
          ...
          href="https://www.linkedin.com/in/juan-barbat-demontel/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <svg
...
const StyledWrapper = styled.div`
  ...
  .SocialIcon .social-link1,
  .SocialIcon .social-link2 {
    position: relative;
    display: flex;
    align-items: center;
  ...
  .SocialIcon .social-link1:hover {
    background-color: #37ffe11a;
    animation: bounce_613 0.4s linear;
  }

  .SocialIcon .social-link2:hover {
    background-color: #37ffe11a;
    animation: bounce_613 0.4s linear;
  }
