...
import "./CertificateBackIII.css"; // Importa el archivo CSS

const CertificateBackIII = () => {
  // Ruta del certificado Backend III - actualizar con la URL real
  const certificateUrl =
    "https://pub.coderhouse.com/legacy-certificates/6858a62d2857c83113af37ae?lang=es";
        ...
        <div className="cppcode">
          <pre id="pre">
            <code>
              ...
              <span className="s2">&lt;#Backend III&gt;</span>
              {"\n"}
              ...
              <span className="s1">
                " Felicidades por completar Backend III en Coderhouse!"
              </span>
...
export default CertificateBackIII;
