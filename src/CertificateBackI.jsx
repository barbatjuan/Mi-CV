...
import "./CertificateBackI.css";

const CertificateBackI = () => {
  ...
  return (
    <MinimizableCertificate 
      ...
      title="Backend I Certificate"
      className="certificate-back1"
      ...
      <div className="cppcode">
        <pre id="pre">
          <code>
            ...
            <span className="s2">&lt;#Backend I&gt;</span>
            {"\n"}
            ...
            <span className="s1">
              " Felicidades por completar Backend I - Avanzado - TOP 10 en Coderhouse!"
            </span>
...
export default CertificateBackI;
